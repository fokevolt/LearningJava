...
public class LocationGenerator {
    ...
    public static File generate(int count) throws Exception {
        ...
        File randomizedLocations = new File("C:\\Users\\vitalii_bondariev\\IdeaProjects\\LearningJava\\randomized_locations.xml");
